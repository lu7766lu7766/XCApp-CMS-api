...
class CreateRoleTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('role', function (Blueprint $table) {
            ...
            $table->enum('is_assign', NYEnumConstants::enum())->default(NYEnumConstants::YES)->comment('是否提供一般使用者使用');
            $table->enum('can_edit', NYEnumConstants::enum())->default(NYEnumConstants::NO)->comment('是否能編輯');
            $table->timestamps();
            //index
